...
def approveReject(a,b,c,d,e):
    ...
    if(e=="'True'"):
        status = "Approved"
        sql = "UPDATE duty set eid = " + d + " WHERE dutyid = " + a
        print(sql)
        mycursor.execute(sql)
        mydb.commit()
        sql = "UPDATE duty set  eid = " + c + " WHERE dutyid = " + b
        print(sql)
        mycursor.execute(sql)
        mydb.commit()
        sql = "UPDATE exchange set Status='Approved' WHERE approver = " + d
        print(sql)
        mycursor.execute(sql)
        mydb.commit()
        ...
        status = "Rejected"
        sql = "UPDATE exchange set Status='Rejected' WHERE approver = " + d 
        print(sql)
        mycursor.execute(sql)
        mydb.commit()
